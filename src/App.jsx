          ...
          <>
            ...
            {showNotisBanner && (
              <div style={{ background: "linear-gradient(135deg,rgba(124,58,237,0.1),rgba(245,158,11,0.06))", borderBottom: "1px solid rgba(124,58,237,0.18)", padding: "8px 24px", display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
                ...
                <button onClick={requestNotifPermission} style={{ background: "#002c5f", border: "none", color: "#111827", fontSize: 11, fontWeight: 700, padding: "6px 14px", borderRadius: 8, cursor: "pointer", fontFamily: "Pretendard,sans-serif" }}>허용</button>
              ...
              <aside style={{ width: 260, flexShrink: 0, overflowY: "auto", padding: "20px 16px", display: "flex", flexDirection: "column", gap: 14, background: "rgba(255,255,255,0.7)" }}>
                <div style={{ background: "#ffffff", border: "1px solid #e0e3e8", borderRadius: 18, padding: 16 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                    ...
                    <button onClick={() => setView("community")} style={{ background: "none", border: "none", color: "#6b7280", fontSize: 11, cursor: "pointer", fontFamily: "Pretendard,sans-serif" }}>더보기</button>
                  </div>
                  {posts.length === 0
        ...
        <>
          ...
          {showNotisBanner && (
            <div style={{ background: "linear-gradient(135deg,rgba(124,58,237,0.12),rgba(124,58,237,0.07))", borderBottom: "1px solid rgba(124,58,237,0.18)", padding: "10px 16px", display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
              ...
              <button onClick={requestNotifPermission} style={{ background: "#002c5f", border: "none", color: "#111827", fontSize: 11, fontWeight: 700, padding: "6px 12px", borderRadius: 8, cursor: "pointer", fontFamily: "Pretendard,sans-serif", whiteSpace: "nowrap" }}>허용</button>
          ...
          <header style={{ padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", flexShrink: 0, background: "#002c5f" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div onClick={() => openNotifs()} style={{ position: "relative", cursor: "pointer", width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.12)", borderRadius: 8, border: "1px solid rgba(255,255,255,0.2)" }}>
                ...
                {notifs.filter(n => !n.read).length > 0 && (
                  <div style={{ position: "absolute", top: -4, right: -4, width: 16, height: 16, background: "#f87171", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, fontWeight: 900, color: "#111827", border: "2px solid #002c5f" }}>
                    {notifs.filter(n => !n.read).length > 9 ? "9+" : notifs.filter(n => !n.read).length}
                  </div>
                )}
              </div>
  ...
  return (
    <div style={{ width: "88%", maxWidth: 360, background: "#ffffff", border: "1px solid #e0e3e8", borderRadius: 24, padding: 28, display: "flex", flexDirection: "column", gap: 18 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <p style={{ fontSize: 16, fontWeight: 800, color: "#111827", margin: 0 }}>{target.name}</p>
          <p style={{ fontSize: 11, color: "#6b7280", marginTop: 3 }}>{target.org} · {target.city}</p>
        </div>
      </div>
      <div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#ffffff" }}>
      <div style={S.overlayHeader}>
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontSize: 15, fontWeight: 700, color: "#111827", margin: 0 }}>알림</p>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
        {notifs.length === 0 ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 200, gap: 12 }}>
            ...
            <p style={{ fontSize: 13, color: "#6b7280", fontStyle: "italic" }}>알림이 없습니다.</p>
          </div>
        ) : notifs.map(n => {
...
function AuthView({ onLogin, onRegister, onAdmin }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#f5f6f8", position: "relative", overflow: "hidden" }}>
      {/* 상단 네이비 헤더 배너 */}
      <div style={{ background: "#002c5f", padding: "44px 32px 32px", position: "relative", overflow: "hidden" }}>
        {/* 장식용 원 */}
        ...
        <div style={{ position: "absolute", top: 20, right: 20, width: 80, height: 80, borderRadius: "50%", background: "rgba(0,170,210,0.15)", pointerEvents: "none" }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, position: "relative" }}>
          <div style={{ width: 44, height: 44, background: "#00aad2", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 12px rgba(0,170,210,0.4)" }}>
          ...
          <div>
            <div style={{ fontSize: 20, fontWeight: 900, color: "#ffffff", letterSpacing: "-0.5px" }}>Global Connect</div>
            <div style={{ fontSize: 9, color: "rgba(255,255,255,0.55)", letterSpacing: "0.14em", marginTop: 2 }}>HMG 주재원 부임전 정규교육</div>
          </div>
        </div>
        <div style={{ color: "rgba(255,255,255,0.75)", fontSize: 12, lineHeight: 1.6, position: "relative" }}>
          현대자동차그룹 주재원 여러분을<br/>
          <span style={{ color: "#ffffff", fontWeight: 700 }}>Global Connect</span>에서 환영합니다.
        </div>
      </div>
      ...
      <div style={{ padding: "0 24px", position: "relative" }}>
        <div style={{ display: "flex", gap: 4, background: "rgba(255,255,255,0.8)", padding: 4, borderRadius: 16, border: "1px solid #e0e3e8" }}>
          {[["login","로그인"],["register","회원가입"]].map(([id, label]) => (
            <button key={id} onClick={() => { setMode(id); setStep(1); setErrMsg(""); }} style={{ flex: 1, padding: 10, borderRadius: 12, fontSize: 13, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "Pretendard,sans-serif", background: mode === id ? "#002c5f" : "transparent", color: mode === id ? "#ffffff" : "#6b7280", transition: "all 0.2s" }}>{label}</button>
          ))}
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px 40px", position: "relative", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {mode === "login" && (
          <>
            ...
            <p style={{ textAlign: "center", fontSize: 12, color: "#6b7280", margin: 0 }}>아직 계정이 없으신가요? <button onClick={() => { setMode("register"); setErrMsg(""); }} style={{ background: "none", border: "none", color: "#002c5f", fontWeight: 700, cursor: "pointer", fontFamily: "Pretendard,sans-serif", fontSize: 12 }}>회원가입</button></p>
          </>
        )}
        ...
        {mode === "register" && step === 2 && (
          <>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <button onClick={() => setStep(1)} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 18, padding: 0 }}>←</button>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
              <div style={{ position: "relative" }}>
                ...
                <label htmlFor="regPhoto" style={{ position: "absolute", bottom: -4, right: -4, width: 24, height: 24, background: "#002c5f", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", fontSize: 12 }}>📷</label>
                <input ref={fileRef} id="regPhoto" type="file" accept="image/*" style={{ display: "none" }} onChange={handlePhoto} />
              </div>
              <p style={{ fontSize: 10, color: "#6b7280", margin: 0 }}>프로필 사진 (선택)</p>
            </div>
...
function ProfileForm({ initialData, onSave, onBack, onLogout }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#ffffff", overflow: "hidden" }}>
      <div style={S.overlayHeader}>
        <button onClick={onBack} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 20, padding: 4 }}>←</button>
  ...
  return (
    <div style={{ ...S.overlay, alignItems: "center", justifyContent: "center" }}>
      <div style={{ padding: 40, textAlign: "center", width: "100%", maxWidth: 320, display: "flex", flexDirection: "column", gap: 24, alignItems: "center" }}>
        ...
        <div><h2 style={{ fontSize: 22, fontWeight: 700, color: "#002c5f", margin: 0 }}>관리자 로그인</h2><p style={{ fontSize: 13, color: "#6b7280", marginTop: 6 }}>기획자 전용 비밀번호를 입력해주세요.</p></div>
      ...
      <div style={{ padding: "12px 16px 0", flexShrink: 0 }}>
        <div style={{ display: "flex", gap: 4, background: "rgba(255,255,255,0.8)", padding: 4, borderRadius: 14, border: "1px solid #e0e3e8", marginBottom: 10 }}>
          {[["users","사용자 관리"],["missions","미션 현황"],["posts","게시글 현황"]].map(([id, label]) => (
            <button key={id} onClick={() => setTab(id)} style={{ flex: 1, padding: "8px 4px", borderRadius: 10, fontSize: 11, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "Pretendard,sans-serif", background: tab === id ? "#002c5f" : "transparent", color: tab === id ? "#ffffff" : "#6b7280", transition: "all 0.2s" }}>{label}</button>
          ))}
        </div>
        {/* 채팅 기록 초기화 */}
        <button
      ...
      <div style={S.overlayBody}>
        ...
        {tab === "users" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <p style={{ fontSize: 12, color: "#6b7280" }}>가입 사용자 <strong style={{ color: "#002c5f" }}>{profiles.length}명</strong></p>
            {profiles.map(p => (
              <div key={p.id} style={{ ...S.card, borderRadius: 18 }}>
                {editId === p.id ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    <p style={{ fontSize: 13, fontWeight: 700, color: "#111827", margin: 0 }}>{p.name} — 매칭 정보 수정</p>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p style={{ fontSize: 13, fontWeight: 700, color: "#111827", margin: 0 }}>{p.name} <span style={{ fontSize: 10, color: "#6b7280", fontWeight: 400 }}>({p.org})</span></p>
                      <p style={{ fontSize: 10, color: "#6b7280", marginTop: 2 }}>{p.city} · {p.country}</p>
                      <p style={{ fontSize: 10, color: "#6b7280" }}>{p.concern}</p>
        ...
        {tab === "posts" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <p style={{ fontSize: 12, color: "#6b7280", marginBottom: 4 }}>전체 게시글 <strong style={{ color: "#002c5f" }}>{posts.length}개</strong></p>
            {posts.map(post => (
              <div key={post.id} style={{ ...S.card, borderRadius: 18 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 700, color: "#111827", marginBottom: 4 }}>{post.title}</p>
      ...
      <div style={S.cardLg}>
        ...
        <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
          ...
          <div>
            ...
            <h3 style={{ fontSize: 20, fontWeight: 700, color: "#111827", margin: 0 }}>안녕하세요, {myProfile.name} 님!</h3>
            <p style={{ fontSize: 12, color: "#6b7280", marginTop: 2 }}>{myProfile.city} · {myProfile.country}</p>
          </div>
        </div>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 16 }}>
          <span style={S.amberBadge}>{myProfile.concern}</span>
          {myProfile.interest && <span style={{ ...S.amberBadge, background: "rgba(255,255,255,0.8)", border: "1px solid #e0e3e8", color: "#6b7280" }}>{myProfile.interest}</span>}
        </div>
        <p style={{ fontSize: 12, color: "#6b7280", marginTop: 14 }}>{myProfile.city}에 <strong style={{ color: "#002c5f" }}>{sameCity.length}명</strong>이 함께 부임 예정이에요.</p>
      </div>
      {[["같은 도시", `${myProfile.city} 부임 예정`, sameCity],["같은 나라", `${myProfile.country} 부임 예정`, sameCountry],["비슷한 고민", "공통 관심사", sameConcern]].map(([title, sub, list]) => (
        <section key={title}>
          <div style={{ marginBottom: 12, padding: "0 2px" }}>
            <h4 style={{ fontSize: 15, fontWeight: 800, color: "#111827", margin: 0 }}>{title}</h4>
            <p style={{ fontSize: 9, color: "#6b7280", margin: 0 }}>{sub}</p>
          </div>
          <div style={{ display: "flex", gap: 12, overflowX: "auto", paddingBottom: 12 }}>
            ...
            )) : <div style={{ width: "100%", padding: 28, border: "1.5px dashed #c4b5fd", borderRadius: 20, textAlign: "center", color: "#002c5f", fontSize: 12, fontStyle: "italic", background: "rgba(232,240,248,0.3)" }}>아직 매칭되는 분이 없어요.</div>}
          </div>
        </section>
      ))}
    </div>
...
function Directory({ profiles, uid, onRequest, onChat, onViewProfile }) {
  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <p style={{ fontSize: 12, color: "#6b7280" }}><strong style={{ color: "#002c5f" }}>{filtered.length}명</strong> 검색됨</p>
      {filtered.map(p => (
        <div key={p.id} style={{ ...S.card, display: "flex", alignItems: "center", gap: 14, borderRadius: 20, cursor: "pointer" }} onClick={() => onViewProfile(p)}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ fontSize: 10, color: "#6b7280", margin: 0 }}>{p.org}</p>
            <p style={{ fontSize: 10, color: "#002c5f", fontWeight: 600, marginTop: 2 }}>{p.city} · {p.country}</p>
            <p style={{ fontSize: 10, color: "#6b7280", marginTop: 1 }}>{p.concern}</p>
          </div>
      ...
      <div style={{ ...S.overlayBody, paddingBottom: 40 }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, marginBottom: 28, paddingTop: 8 }}>
          ...
          <div style={{ textAlign: "center" }}>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: "#111827", margin: 0 }}>{profile.name}</h2>
            <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>{profile.org}</p>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
    ...
    <div style={S.overlay}>
      <div style={S.overlayHeader}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 10, color: "#6b7280", margin: 0 }}>{isGroup ? `그룹 채팅 · ${memberProfiles.length}명` : "1:1 채팅"}</p>
        </div>
        {currentRoom && (
          <div style={{ display: "flex", gap: 6 }}>
            <button onClick={() => setShowPanel(showPanel === "members" ? null : "members")} style={{ background: "rgba(255,255,255,0.8)", border: "1px solid #e0e3e8", color: "#6b7280", fontSize: 11, fontWeight: 700, padding: "5px 8px", borderRadius: 8, cursor: "pointer", fontFamily: "Pretendard,sans-serif" }}>멤버</button>
      ...
      {showPanel === "members" && (
        <div style={{ background: "rgba(255,255,255,0.03)", borderBottom: "1px solid #e0e3e8", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 8, maxHeight: 200, overflowY: "auto" }}>
          <p style={{ fontSize: 11, fontWeight: 700, color: "#6b7280", margin: 0 }}>참여 멤버 {memberProfiles.length}명</p>
          {memberProfiles.map(p => (
            <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 10, color: "#6b7280" }}>{p.org}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {showPanel === "invite" && (
        <div style={{ background: "rgba(255,255,255,0.03)", borderBottom: "1px solid #e0e3e8", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 8, maxHeight: 240, overflowY: "auto" }}>
          <p style={{ fontSize: 11, fontWeight: 700, color: "#6b7280", margin: 0 }}>초대할 멤버 선택</p>
          {nonMembers.length === 0 ? <p style={{ fontSize: 12, color: "#6b7280", fontStyle: "italic" }}>초대할 수 있는 멤버가 없어요.</p> :
            nonMembers.map(p => {
              ...
              return (
                <div key={p.id} onClick={() => setInvitees(prev => sel ? prev.filter(id => id !== p.id) : [...prev, p.id])} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 8px", borderRadius: 10, background: sel ? "#f5f6f8" : "none", cursor: "pointer" }}>
                  ...
                  <div style={{ width: 16, height: 16, borderRadius: 5, border: `2px solid ${sel ? "#002c5f" : "#d1d8e0"}`, background: sel ? "#002c5f" : "#ffffff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#111827" }}>{sel ? "✓" : ""}</div>
                </div>
              );
            })
          }
          ...
          return (
            <div key={m.id} style={{ display: "flex", gap: 8, flexDirection: mine ? "row-reverse" : "row", alignItems: "flex-end" }}>
              ...
              <div style={{ maxWidth: "72%", display: "flex", flexDirection: "column", gap: 3, alignItems: mine ? "flex-end" : "flex-start" }}>
                {!mine && showHead && <span style={{ fontSize: 10, color: "#6b7280", marginLeft: 2 }}>{m.senderName}</span>}
                <div style={{ padding: "10px 14px", borderRadius: mine ? "18px 18px 4px 18px" : "18px 18px 18px 4px", fontSize: 13, background: mine ? "#002c5f" : "#ffffff", color: mine ? "#ffffff" : "#111827", fontWeight: mine ? 600 : 400, border: mine ? "none" : "1px solid #e8ecf0" }}>{m.text}</div>
    ...
    <div style={{ padding: "16px 20px 0" }}>
      <div style={{ display: "flex", gap: 4, background: "rgba(255,255,255,0.8)", padding: 4, borderRadius: 16, border: "1px solid #e0e3e8" }}>
        {[["received","받은 신청"],["sent","보낸 신청"],["chat","채팅"]].map(([id, label]) => (
          <button key={id} onClick={() => setTab(id)} style={{ flex: 1, padding: 10, borderRadius: 12, fontSize: 13, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "Pretendard,sans-serif", background: tab === id ? "#002c5f" : "transparent", color: tab === id ? "#ffffff" : "#6b7280", transition: "all 0.2s" }}>{label}</button>
        ))}
      </div>
    </div>
    <div style={{ flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
      {tab === "received" && (received.length === 0 ? <div style={{ padding: 36, border: "1px dashed rgba(255,255,255,0.1)", borderRadius: 20, textAlign: "center", color: "#6b7280", fontSize: 12, fontStyle: "italic" }}>아직 받은 신청이 없어요.</div> : received.map(m => {
      ...
      {tab === "sent" && (sent.length === 0 ? <p style={{ textAlign: "center", padding: 20, color: "#6b7280", fontSize: 12, fontStyle: "italic" }}>먼저 동료에게 신청을 보내보세요!</p> : sent.map(m => {
      ...
      {tab === "chat" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {/* 1:1 채팅 */}
          {(dmRooms||[]).length > 0 && <>
            <p style={{ fontSize: 10, fontWeight: 700, color: "#6b7280", letterSpacing: "0.08em", margin: "4px 2px 0" }}>1:1 채팅</p>
            {(dmRooms||[]).map(dm => {
          ...
          {/* 그룹 채팅 */}
          {myRooms.length > 0 && <>
            <p style={{ fontSize: 10, fontWeight: 700, color: "#6b7280", letterSpacing: "0.08em", margin: "8px 2px 0" }}>그룹 채팅</p>
            {myRooms.map(room => (
              <button key={room.id} onClick={() => onOpenChat(room.id, room.name)} style={{ display: "flex", alignItems: "center", gap: 14, ...S.card, borderRadius: 18, cursor: "pointer", width: "100%", textAlign: "left" }}>
                ...
                <div style={{ flex: 1 }}><p style={{ fontSize: 14, fontWeight: 700, color: "#111827", margin: 0 }}>{room.name}</p><p style={{ fontSize: 11, color: "#6b7280", marginTop: 2 }}>멤버 {room.members?.length||0}명</p></div>
                <span style={{ color: "#6b7280" }}>→</span>
              </button>
            ))}
          </>}
          {(dmRooms||[]).length === 0 && myRooms.length === 0 && (
            <p style={{ textAlign: "center", padding: 32, color: "#6b7280", fontSize: 12, fontStyle: "italic" }}>아직 참여 중인 채팅방이 없어요.<br/>티미팅을 수락하면 1:1 채팅이 시작됩니다!</p>
          )}
        </div>
      )}
    </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <p style={{ fontSize: 12, color: "#6b7280", margin: 0 }}><strong style={{ color: "#002c5f" }}>{posts.length}개</strong>의 게시글</p>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
        {tab === "board" && (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><p style={{ fontSize: 12, color: "#6b7280", margin: 0 }}><strong style={{ color: "#002c5f" }}>{posts.length}개</strong>의 게시글</p><button onClick={onNewPost} style={{ ...S.btnAmber, padding: "8px 14px", fontSize: 12, borderRadius: 12 }}>+ 글쓰기</button></div>
            {posts.map(post => {
              const author = profiles.find(p => p.id === post.authorId) || { name: post.authorName, id: post.authorId };
              return (
                <div key={post.id} onClick={() => onOpenPost(post)} style={{ ...S.card, borderRadius: 22, cursor: "pointer", display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {tab === "groups" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button onClick={() => onOpenChat("global", "전체 채팅방")} style={{ display: "flex", alignItems: "center", gap: 14, background: "linear-gradient(135deg,rgba(245,158,11,0.1),transparent)", border: "1px solid rgba(124,58,237,0.18)", borderRadius: 18, padding: 16, cursor: "pointer", width: "100%", textAlign: "left" }}>
              ...
              <div style={{ flex: 1 }}><p style={{ fontSize: 14, fontWeight: 700, color: "#111827", margin: 0 }}>전체 채팅방</p><p style={{ fontSize: 11, color: "#6b7280", marginTop: 2 }}>모든 참여자 {profiles.length}명</p></div>
            ...
            {myRooms.length > 0 && (
              <>
                <p style={{ fontSize: 10, fontWeight: 700, color: "#6b7280", letterSpacing: "0.08em", margin: "4px 2px 0" }}>그룹 채팅</p>
                {myRooms.map(room => (
                  <button key={room.id} onClick={() => onOpenChat(room.id, room.name)} style={{ display: "flex", alignItems: "center", gap: 14, ...S.card, borderRadius: 18, cursor: "pointer", width: "100%", textAlign: "left" }}>
                    <div style={{ width: 44, height: 44, background: "rgba(255,255,255,0.8)", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>💬</div>
                    <div style={{ flex: 1 }}>
                      <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", margin: 0 }}>{room.name}</p>
                      <p style={{ fontSize: 11, color: "#6b7280", marginTop: 2 }}>멤버 {room.members?.length || 0}명</p>
                    </div>
                    <span style={{ color: "#6b7280" }}>→</span>
                  </button>
                ))}
            ...
            {dmRooms.length === 0 && myRooms.length === 0 && (
              <p style={{ fontSize: 12, color: "#6b7280", fontStyle: "italic", textAlign: "center", padding: "20px 0" }}>참여 중인 채팅방이 없어요.<br/>동료에게 채팅을 걸거나 새 채팅방을 만들어보세요!</p>
            )}
            {!showCreate ? (
              <button onClick={() => setCreate(true)} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: 14, border: "2px dashed rgba(255,255,255,0.12)", borderRadius: 18, background: "none", color: "#6b7280", cursor: "pointer", fontFamily: "Pretendard,sans-serif", fontSize: 13, fontWeight: 700, width: "100%" }}>+ 채팅방 만들기</button>
            ) : (
              <div style={{ ...S.card, borderRadius: 18, display: "flex", flexDirection: "column", gap: 12, border: "1px solid rgba(124,58,237,0.25)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", margin: 0 }}>새 채팅방</p>
                  <button onClick={() => setCreate(false)} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 18 }}>✕</button>
                </div>
                ...
                <div>
                  ...
                  {profiles.filter(p => p.id !== uid).map(p => {
                    ...
                    return (
                      <div key={p.id} onClick={() => setNewRoom(r => ({ ...r, invitees: sel ? r.invitees.filter(id => id !== p.id) : [...r.invitees, p.id] }))} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 12, background: sel ? "#f5f6f8" : "rgba(255,255,255,0.03)", border: `1px solid ${sel ? "rgba(0,44,95,0.25)" : "rgba(255,255,255,0.85)"}`, cursor: "pointer", marginBottom: 6 }}>
                        <Avatar profile={p} size={30} />
                        <p style={{ fontSize: 13, color: "#002c5f", margin: 0, flex: 1 }}>{p.name}</p>
                        <div style={{ width: 18, height: 18, borderRadius: 6, border: `2px solid ${sel ? "#002c5f" : "#d1d8e0"}`, background: sel ? "#002c5f" : "#ffffff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#111827" }}>{sel ? "✓" : ""}</div>
                      </div>
                    );
                  })}
                </div>
...
function PostDetail({ post: initialPost, profiles, uid, myProfile, onAddComment, onToggleLike, onEditPost, onDeletePost, onDeleteComment, onBack, db }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#ffffff", overflow: "hidden" }}>
      <div style={S.overlayHeader}>
        <button onClick={onBack} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 20, padding: 4 }}>←</button>
        <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", margin: 0 }}>{post.title}</p>
      ...
      <div style={{ ...S.overlayBody, paddingBottom: 40 }}>
        {isEditing ? (
          ...
          /* 보기 모드 */
          <>
            <p style={{ fontSize: 17, fontWeight: 800, color: "#111827", marginBottom: 4, lineHeight: 1.4 }}>{post.title}</p>
            ...
            <div style={{ display: "flex", gap: 14, paddingTop: 4, marginBottom: 20 }}>
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: "#6b7280" }}>💬 댓글 {comments.length}개</span>
            </div>
          </>
        )}
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(255,255,255,0.05)", padding: "10px 14px", borderRadius: 16, position: "relative" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                        <p style={{ fontSize: 10, fontWeight: 700, color: "#6b7280", margin: 0 }}>{c.authorName}</p>
                        {/* 본인 댓글 삭제 */}
                        {mine && (
                          <button onClick={() => { if (window.confirm("댓글을 삭제하시겠습니까?")) onDeleteComment(c.id); }} style={{ background: "none", border: "none", color: "#6b7280", fontSize: 11, cursor: "pointer", fontFamily: "Pretendard,sans-serif", padding: 0 }}>삭제</button>
                        )}
                      </div>
...
function NewPost({ onSubmit, onBack }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#ffffff", overflow: "hidden" }}>
      <div style={S.overlayHeader}>
        <button onClick={onBack} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 20, padding: 4 }}>✕</button>
        <p style={{ fontSize: 15, fontWeight: 700, color: "#111827", flex: 1, margin: 0 }}>글쓰기</p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div>
            ...
            {preview ? <div style={{ position: "relative" }}><img src={preview} alt="" style={{ width: "100%", borderRadius: 14, maxHeight: 200, objectFit: "cover" }} /><button onClick={() => { setPreview(null); setForm(f => ({ ...f, imageUrl: "" })); }} style={{ position: "absolute", top: 8, right: 8, width: 30, height: 30, background: "rgba(243,240,255,0.8)", border: "1px solid #e0e3e8", borderRadius: 10, color: "#002c5f", cursor: "pointer", fontSize: 14 }}>✕</button></div>
              : <label htmlFor="newPostImg" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, padding: 32, border: "2px dashed rgba(255,255,255,0.1)", borderRadius: 18, cursor: "pointer", color: "#6b7280", fontSize: 12 }}>🖼️<span>사진을 첨부하려면 여기를 탭하세요</span></label>}
  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ ...S.cardLg, background: "linear-gradient(135deg,rgba(124,58,237,0.1),rgba(56,189,248,0.06))", border: "1px solid rgba(124,58,237,0.18)", textAlign: "center" }}>
        {allDone ? (
          <><div style={{ fontSize: 48, marginBottom: 8 }}>🎉</div><h2 style={{ fontSize: 20, fontWeight: 800, color: "#111827", margin: 0 }}>네트워크 미션 완료!</h2><p style={{ fontSize: 13, color: "#6b7280", marginTop: 8 }}>모든 미션을 완료하셨습니다. 수고하셨어요!</p></>
        ) : (
          <>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 800, color: "#111827", margin: 0 }}>네트워크 미션</h2>
          ...
          <div style={{ display: "flex", gap: 14, alignItems: "flex-start", marginBottom: 14 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                ...
                {m.disabled && <span style={{ background: "rgba(255,255,255,0.85)", color: "#6b7280", fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 6 }}>비활성화</span>}
              ...
              <p style={{ fontSize: 15, fontWeight: 700, color: "#111827", margin: 0, marginBottom: 4 }}>{m.title}</p>
                ...
                <div style={{ display: "flex", gap: 8, overflowX: "auto", paddingBottom: 4 }}>
                  {m.photos.map((p, i) => (
                    <div key={i} style={{ position: "relative", flexShrink: 0 }}>
                      ...
                      >×</button>
                      {/* 교체 버튼 */}
                      <label htmlFor={`replace_${m.id}_${i}`} style={{ position: "absolute", bottom: -6, right: -6, width: 22, height: 22, borderRadius: "50%", background: m.color, border: "2px solid #020617", color: "#111827", fontSize: 10, fontWeight: 900, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>↺</label>
  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ background: "linear-gradient(135deg,rgba(124,58,237,0.12),rgba(56,189,248,0.07))", border: "1px solid rgba(124,58,237,0.2)", borderRadius: 24, padding: "20px 24px", position: "relative", overflow: "hidden" }}>
        ...
        <h2 style={{ fontSize: 20, fontWeight: 900, color: "#111827", margin: 0 }}>교육 시간표</h2>
      </div>
      ...
      {SCHEDULE_DATA.length > 1 && (
        <div style={{ display: "flex", gap: 6 }}>
          {SCHEDULE_DATA.map((d, i) => (
            <button key={i} onClick={() => setActiveDay(i)} style={{ padding: "8px 18px", borderRadius: 12, fontSize: 13, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "Pretendard,sans-serif", background: activeDay === i ? "#002c5f" : "#ffffff", color: activeDay === i ? "#ffffff" : "#6b7280", transition: "all 0.2s" }}>{d.day}</button>
          ))}
        </div>
      )}
        ...
        {day.sessions.map((s, i) => (
          <div key={i} style={{ display: "flex", gap: 0, background: "#ffffff", border: "1px solid #e0e3e8", borderRadius: 18, overflow: "hidden" }}>
            ...
            <div style={{ flex: 1, padding: "14px 16px", minWidth: 0 }}>
              <p style={{ fontSize: 15, fontWeight: 800, color: "#111827", margin: "0 0 6px", lineHeight: 1.3 }}>{s.title}</p>
    ...
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ ...S.card, borderRadius: 22 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 700, color: "#111827", margin: 0 }}>{calYear}년 {MONTHS[calMonth]}</p>
        ...
        {weeks.map((row, wi) => (
          <div key={wi} style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 2 }}>
            {row.map((day, di) => {
              ...
              return (
                <div key={di} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "8px 0", borderRadius: 10, background: isToday ? "#002c5f" : "none" }}>
                  <span style={{ fontSize: 12, fontWeight: 600, color: isToday ? "#020617" : day ? (di===0?"#f87171":"#64748b") : "transparent" }}>{day||""}</span>
                  {hasEv(day) && <div style={{ width: 5, height: 5, background: isToday ? "#ffffff" : "#002c5f", borderRadius: "50%", marginTop: 2 }} />}
                </div>
              );
            })}
          </div>
      ...
      {showForm && (
        <div style={{ ...S.card, borderRadius: 22, border: "1px solid rgba(124,58,237,0.25)", display: "flex", flexDirection: "column", gap: 10 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><p style={{ fontSize: 14, fontWeight: 700, color: "#111827", margin: 0 }}>새 일정</p><button onClick={() => setShowForm(false)} style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", fontSize: 18 }}>✕</button></div>
      ...
      {accepted.length > 0 && (
        <div>
          <h4 style={{ fontSize: 13, fontWeight: 700, color: "#111827", marginBottom: 10 }}>☕ 수락된 티미팅 <span style={{ color: "#0a6640" }}>{accepted.length}건</span></h4>
          {accepted.map(m => (
            <div key={m.id} style={{ display: "flex", alignItems: "center", gap: 12, background: "rgba(34,197,94,0.05)", border: "1px solid rgba(16,185,129,0.1)", borderRadius: 16, padding: "12px 14px", marginBottom: 8 }}>
              ...
              <div><p style={{ fontSize: 13, fontWeight: 700, color: "#111827", margin: 0 }}>티미팅 · {m.fromId === uid ? m.toName : m.fromName}</p><p style={{ fontSize: 10, color: "#6b7280" }}>{m.fromId === uid ? m.toOrg : m.fromOrg}</p></div>
            </div>
          ))}
        </div>
      )}
      ...
      <div>
        <h4 style={{ fontSize: 13, fontWeight: 700, color: "#111827", marginBottom: 10 }}>⏰ 오늘 일정</h4>
        {todayEvs.length === 0 ? <p style={{ fontSize: 12, color: "#6b7280", fontStyle: "italic" }}>오늘 예정된 일정이 없습니다.</p> : todayEvs.map(e => (
          <div key={e.id} style={{ display: "flex", alignItems: "center", gap: 10, background: "rgba(245,158,11,0.05)", border: "1px solid rgba(245,158,11,0.1)", borderRadius: 14, padding: "12px 14px", marginBottom: 8 }}>
            <div style={{ width: 8, height: 8, background: "#002c5f", borderRadius: "50%", flexShrink: 0 }} />
            <div><p style={{ fontSize: 13, fontWeight: 700, color: "#111827", margin: 0 }}>{e.title}</p>{e.time && <p style={{ fontSize: 10, color: "#6b7280" }}>{e.time}</p>}{e.note && <p style={{ fontSize: 10, color: "#6b7280" }}>{e.note}</p>}</div>
          </div>
        ))}
      </div>

      <div>
        <h4 style={{ fontSize: 13, fontWeight: 700, color: "#111827", marginBottom: 10 }}>📅 다가오는 일정</h4>
        {upcoming.length === 0 ? <p style={{ fontSize: 12, color: "#6b7280", fontStyle: "italic" }}>예정된 일정이 없습니다.</p> : upcoming.map(e => (
          <div key={e.id} style={{ display: "flex", alignItems: "center", gap: 14, ...S.card, borderRadius: 16, marginBottom: 8 }}>
            <div style={{ textAlign: "center", width: 42, flexShrink: 0 }}><p style={{ fontSize: 9, color: "#6b7280", margin: 0 }}>{e.date?.slice(5,7)}월</p><p style={{ fontSize: 20, fontWeight: 900, color: "#111827", lineHeight: 1, margin: 0 }}>{e.date?.slice(8,10)}</p></div>
            <div style={{ width: 1, height: 32, background: "rgba(255,255,255,0.08)", flexShrink: 0 }} />
            <div style={{ flex: 1, minWidth: 0 }}><p style={{ fontSize: 13, fontWeight: 700, color: "#111827", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{e.title}</p>{e.time && <p style={{ fontSize: 10, color: "#6b7280" }}>{e.time}</p>}{e.note && <p style={{ fontSize: 10, color: "#6b7280", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{e.note}</p>}</div>
